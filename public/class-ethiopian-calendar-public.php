...
class Ethiopian_Calendar_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name."-converter", plugin_dir_url( __FILE__ ) . 'js/eth-cal.js', array(  ), $this->version, false );
		wp_enqueue_script( $this->plugin_name."-main", plugin_dir_url( __FILE__ ) . 'js/ethiopian-calendar-public.js', array( $this->plugin_name."-converter" ), $this->version, true );
	...
	public function add_ethiocalendar_shortcodes()
	{
		add_shortcode( 'ethcalendar', array($this,'show_eth_calendar') );
	}

	public function show_eth_calendar($atts)
	{

		ob_start();
		require 'partials/ethiopian-calendar-public-display.php';
		$sss=  ob_get_clean();
